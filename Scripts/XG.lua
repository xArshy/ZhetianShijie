...
function XG:LXDT1()
    ...
    for i = 0, 6, 1 do
        ...
        npc:AddTitle("Disciples in Lingxu Dongtian", 0, CS.XiaWorld.g_emNpcTitleType.Normal, 1)
        npc.PropertyMgr:AddFeature("ZTofBody")
        npc.BodyColor = 4
        npc:AddLing(9999999)
        npc.FightBody.AutoNext = true
...
function XG:LXDT2()
    ...
    for i = 1, 9, 3 do
        ...
        ThingMgr:EquptNpc(npc, 5, CS.XiaWorld.g_emNpcRichLable.Normal)
        npc.PropertyMgr.Practice:Up2Disciple(CS.XiaWorld.PracticeMgr.Instance:RandomGong(), 12)
        npc:AddTitle("Disciples in Lingxu Dongtian", 0, CS.XiaWorld.g_emNpcTitleType.Normal, 2)
        npc.PropertyMgr:AddFeature("ZTofBody")
        npc.BodyColor = 4
        npc:AddLing(9999999)
        npc.FightBody.AutoNext = true
        ...
        for i = 1, 9, 3 do
            ...
            NpcMgr:AddNpc(npc, 1000 + 150 * i, Map, CS.XiaWorld.Fight.g_emFightCamp.Enemy)
            ThingMgr:EquptNpc(npc, 5, CS.XiaWorld.g_emNpcRichLable.Normal)
            npc:AddTitle("Disciples in Lingxu Dongtian", 0, CS.XiaWorld.g_emNpcTitleType.Normal, 3)
            npc.PropertyMgr.Practice:Up2Disciple(CS.XiaWorld.PracticeMgr.Instance:RandomGong(), 12)
            npc.PropertyMgr:AddFeature("ZTofBody")
            npc.BodyColor = 4
            npc:AddLing(9999999)
